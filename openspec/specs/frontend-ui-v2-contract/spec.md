...
Define the backend API contract required by the current frontend UI v1/v2 to unblock core user flows without requiring backend features beyond the MVP scope.
